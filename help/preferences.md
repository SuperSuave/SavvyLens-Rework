...
* MQTT allows SavvyLens to connect to a broker for CAN transmission over the internet. You will need to set up the host, port, username, and password. These things are determined by your broker. You can run your own on Linux with Mosquitto. Yes, api.SavvyLens.com really does exist but, no, you can't actually connect as Anonymous and use it. Sorry...
