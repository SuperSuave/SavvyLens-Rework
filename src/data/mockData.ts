...
export const INITIAL_CONNECTIONS: ConnectionConfig[] = [
  {
    ...
    status: 'Connected',
    baudRate: 500000,
    port: '192.168.4.1:23 (GVRET over IP)',
    ipAddress: '192.168.4.1',
    tcpPort: 23,
    isLogging: true,
    deviceFamily: 'CAN-Do',
    deviceModel: 'WiCAN OBD-II (ESP32-C3)',
  ...
  },
  {
    ...
    status: 'Disconnected',
    baudRate: 500000,
    port: 'wican.local:23 (GVRET over IP)',
